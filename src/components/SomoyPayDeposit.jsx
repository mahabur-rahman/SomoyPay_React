...
const SomoyPayDeposit = () => {
  ...
  const handleConfirmDeposit = async () => {
    ...
    try {
      ...
      if (data.status === 201 && data.data.payment_url) {
        console.log("Redirecting to payment URL...");
        // Log the URL to ensure it's correct
        console.log("Payment URL:", data.data.payment_url);
        // Correct way to redirect to the payment URL
        window.location.href = data.data.payment_url;  // This line will trigger the redirect

        // After redirection, redirect to dashboard page
        // Uncomment this part if you want the user to be sent to the dashboard after successful payment
